...
<head>
  ...
  <title>{{ $title ?? 'HTN STAIMAS Wonogiri' }} – Hukum Tata Negara S1</title>
  <meta name="description" content="{{ $description ?? 'Program Studi Hukum Tata Negara (HTN) S1 STAIMAS Wonogiri – Mencetak Da\'i, Jurnalis, dan Komunikator Islam yang Profesional.' }}" />
...
<body class="bg-gray-50 text-gray-800 antialiased font-sans">
  ...
  <header class="sticky top-0 bg-white border-b border-gray-100 z-40 transition-all duration-300" id="navbar">
    <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
      <a href="{{ route('home') }}" class="flex items-center gap-3 group">
        <div class="logo-icon w-12 h-12 bg-white rounded-full flex items-center justify-center border-2 border-yellow-500 shadow-md overflow-hidden">
          <img src="{{ asset('assest/HTN.jpeg') }}" alt="HTN Logo" class="w-full h-full object-contain p-0.5">
        </div>
        <div>
          <span class="block text-lg font-extrabold text-teal-700 tracking-tight leading-none">HTN STAIMAS</span>
      ...
      <nav class="hidden lg:block">
        <ul class="flex items-center gap-8 text-[14px] font-medium text-gray-600">
          ...
          <li><a href="{{ route('pages.berita') }}" class="nav-link hover:text-teal-700 transition-colors py-2 {{ request()->routeIs('pages.berita*') ? 'font-bold text-teal-700 active' : '' }}">Berita HTN</a></li>
    ...
    <div class="mobile-dropdown lg:hidden border-t border-gray-100 bg-white shadow-lg" id="mobile-menu">
      <ul class="flex flex-col px-4 py-2">
        ...
        <li><a href="{{ route('pages.berita') }}" class="flex items-center gap-3 py-3 border-b border-gray-100 text-sm font-semibold text-gray-700 hover:text-teal-700"><i class="fas fa-newspaper w-4 text-teal-600"></i> Berita HTN</a></li>
  ...
  <footer class="bg-teal-900 text-gray-300">
    <div class="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-xs">
      <div class="space-y-3">
        <h3 class="font-extrabold text-white text-sm">Prodi HTN STAIMAS Wonogiri</h3>
        <p class="text-gray-400 leading-relaxed">Mendidik praktisi hukum, konsultan konstitusi, dan ahli hukum tata negara yang profesional, unggul, dan berwawasan kebangsaan.</p>
      </div>
      <div class="space-y-3">
    ...
    <div class="border-t border-teal-800 py-4 text-center text-[10px] text-gray-500">
      <p>© 2026 Program Studi Hukum Tata Negara STAIMAS Wonogiri. All Rights Reserved.</p>
    </div>
  </footer>
