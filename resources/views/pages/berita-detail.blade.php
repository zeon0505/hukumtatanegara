        ...
        <div class="p-6 sm:p-8 space-y-6">
          ...
          <blockquote class="border-l-4 border-teal-600 bg-teal-50 rounded-r-2xl px-6 py-4 my-4">
            <p class="text-teal-800 text-sm font-semibold italic leading-relaxed">
              "Kami terus berkomitmen memajukan kualitas lulusan HTN STAIMAS Wonogiri yang berakhlak mulia dan profesional."
            </p>
            <footer class="text-xs text-teal-600 font-bold mt-2">— Kaprodi HTN STAIMAS</footer>
          </blockquote>
        </div>
      </article>
