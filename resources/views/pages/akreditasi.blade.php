...
<div class="max-w-6xl mx-auto space-y-6">
  ...
  <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden p-1 sm:p-2">
    <iframe
      src="https://docs.google.com/gview?url={{ urlencode(asset('assest/Sertifikat Akreditasi HTN.pdf')) }}&embedded=true"
      class="w-full"
      style="height: 78vh; min-height: 550px; border: none;"
      title="Sertifikat Akreditasi HTN">
    </iframe>
  </div>

  {{-- Tombol Aksi di Bawah --}}
  <div class="flex justify-center gap-3">
    <a href="{{ asset('assest/Sertifikat%20Akreditasi%20HTN.pdf') }}" target="_blank"
    ...
    <a href="{{ asset('assest/Sertifikat%20Akreditasi%20HTN.pdf') }}" download
