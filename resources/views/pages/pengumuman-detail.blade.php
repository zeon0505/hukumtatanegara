@extends('layouts.app')
@section('title', $poster->judul . ' - Prodi HTN STAIMAS')
          ...
          <div class="flex items-center gap-3 border-b border-gray-100 pb-4">
            ...
            <div class="leading-tight">
              <div class="flex items-center gap-1.5">
                <span class="font-extrabold text-gray-900 text-sm">prodihtn_staimas</span>
                <i class="fas fa-check-circle text-teal-600 text-xs"></i>
              </div>
              <span class="text-[11px] text-gray-400 font-medium block">Prodi HTN &bull; {{ $poster->created_at->isoFormat('D MMMM Y') }}</span>
            </div>
          </div>
