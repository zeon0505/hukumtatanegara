...
<div class="space-y-10">
  ...
  <p class="text-gray-500 text-sm text-center">Program Studi HTN STAIMAS Wonogiri didukung oleh tenaga pengajar yang berkualifikasi dan berdedikasi tinggi di bidang Hukum Tata Negara.</p>
  ...
  <div class="bg-gradient-to-br from-teal-800 to-teal-900 rounded-3xl p-8 text-center text-white space-y-4">
    <h3 class="text-2xl font-black">Bergabunglah dengan Keluarga HTN STAIMAS</h3>
